...
\begin{exercise}
Find the limit if $f(x) = x^2.$ 

\[ \lim\limits_{x \to 2} f(x) = \answer{4} \]
...
Select all that apply.   \\  \\  %Not working!
...
%\begin{center} %% Image is found in xmPictures, where all images should go
